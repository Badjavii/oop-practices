package com.github.badjavii.p03_Users;
import com.github.badjavii.p01_Interfaces.ContenidoDescargable;
...
public class User {
    ...
    public void descargarContenido(ContenidoMultimedia contenido){
        ...
        boolean sePuedeDescargar = ((ContenidoDescargable) contenido).verificarEspacioRequerido(espacioDisponible);
